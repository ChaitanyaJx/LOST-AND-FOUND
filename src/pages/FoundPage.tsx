...
function FoundPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-black">
      {/* Header */}
      <header className="py-10 px-8 bg-[#CF0F47]">
        <motion.div
      ...
      {/* Footer */}
      <footer className="py-6 px-8 bg-black border-t border-[#CF0F47] mt-8">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4 mt-4 md:mt-0">
            <a
              href="#"
              className="text-gray-400 hover:text-[#FF0B55] transition-colors"
            >
              Privacy Policy
            </a>
            <a
